...
**الحالة**: 🟢 المراحل 1-3 مكتملة (40% من الخطة الشاملة)
...
## 🔜 المتبقي (Remaining - 60%)

### المرحلة 4(ب): توحيد الشحن
- ❌ إزالة ازدواج `shipments` و `shipments_tracking`
- ❌ ربط `shipment_events` بمسار واحد
- ❌ توحيد `tracking_number` و `shipment_number`

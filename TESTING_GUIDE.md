...
- [ ] **لوحة المسوق الرئيسية** (`/affiliate-dashboard`)
...
- [ ] **إدارة المسوقين** (`/admin/users`)
  - عرض قائمة المسوقين مع متاجرهم
  - تفاصيل كل مسوق وعدد منتجاته
  - إمكانية تعديل صلاحيات المسوقين

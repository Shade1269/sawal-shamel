    ...
    <div className="min-h-screen bg-gradient-persian-bg">
      ...
      <div className="container mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          <Card className="gradient-card-primary border-primary/20">
          ...
          <Card className="gradient-card-success border-success/20">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
          ...
          <Card className="gradient-card-destructive border-danger/20">
            <CardContent className="p-6">
              <div className="flex items-center justify-between">
                <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {filteredProducts.map((product) => (
            ...
            >
              <div className="relative">
                <div className="aspect-square gradient-bg-muted flex items-center justify-center">

          ...
          <CardHeader className="pb-6">
            <CardTitle id="inventory-integration-admin" className="text-3xl font-black admin-card">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-success shadow-glow flex items-center justify-center">
                  <Package className="h-5 w-5 text-white" />
                </div>
                نظام المخزون الداخلي
              </div>
            </CardTitle>
            <CardDescription className="text-base admin-text">
        ...
        <Card className="admin-card-enhanced">
          <CardHeader className="pb-6">
            <CardTitle id="cron-monitoring" className="text-3xl font-black admin-card">
              <div className="flex items-center gap-4">
                <div className="w-10 h-10 rounded-xl bg-info shadow-glow flex items-center justify-center">
        ...
        <CardContent className="p-8">
          ...
          <div className="mb-12">
            <div className="flex items-center gap-4 mb-8">
              <div className="w-12 h-12 rounded-2xl gradient-btn-primary flex items-center justify-center shadow-lg shadow-primary/25 ring-2 ring-primary/20">

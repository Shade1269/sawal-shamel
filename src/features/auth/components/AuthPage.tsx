...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-anaqati-cream flex items-center justify-center p-4 relative overflow-hidden">
        ...
        <div className="bg-white rounded-2xl border border-anaqati-border shadow-anaqati p-6 md:p-8">
          <Tabs defaultValue="signin" className="w-full">
            <TabsList className="grid w-full grid-cols-3 mb-8 bg-anaqati-cream p-1 rounded-xl">
              <TabsTrigger 
                value="signin" 
                className="gap-2 data-[state=active]:bg-anaqati-burgundy data-[state=active]:text-white rounded-lg py-2.5 text-sm font-semibold transition-all"
              >
              ...
              <form onSubmit={handleSignIn} className="space-y-5">
                <div className="space-y-2 text-right">
                  ...
                  <Input
                    ...
                    required
                    className="h-12 bg-anaqati-cream border-anaqati-border focus:border-anaqati-burgundy focus:ring-anaqati-burgundy/20 rounded-xl text-right"
                  />
                </div>
                ...
                <Button 
                  type="submit" 
                  className="w-full h-12 text-base font-bold rounded-xl bg-anaqati-burgundy hover:bg-anaqati-burgundy-hover text-white shadow-anaqati"
                  disabled={isLoading}
                >
                ...
                <form onSubmit={handleSignUp} className="space-y-5">
                  <div className="space-y-2 text-right">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 bg-anaqati-cream border-anaqati-border focus:border-anaqati-burgundy rounded-xl text-right"
                    />
                  </div>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-xl border-2 transition-all ${
                          signUpForm.role === 'affiliate'
                            ? 'border-anaqati-burgundy bg-anaqati-pink-light'
                            : 'border-anaqati-border bg-white hover:border-anaqati-burgundy/50'
                        }`}
                      >

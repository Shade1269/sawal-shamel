        ...
        <div className="grid md:grid-cols-2 gap-0">
          ...
          <div className="p-6 md:p-8 space-y-6">
            ...
            <Tabs defaultValue="description" dir="rtl">
              ...
              <TabsContent value="description" className="space-y-4 mt-4 bg-secondary p-4 rounded-lg">
                <p className="text-secondary-foreground leading-relaxed text-right">
                  {product.description}
                </p>
              </TabsContent>
              
              <TabsContent value="details" className="space-y-3 mt-4 bg-secondary p-4 rounded-lg" dir="rtl">

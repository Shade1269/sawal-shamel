  ...
  "relative overflow-hidden transition-all duration-500 cursor-pointer group",
  {
    variants: {
      variant: {
        ...
        gradient: "gradient-card-primary border border-primary/30"
      },
      size: {
        sm: "p-4 h-32",
        md: "p-6 h-40",
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-300">
        ...
        <div className="absolute top-0 left-0 w-full h-1 gradient-btn-accent transform scale-x-0 group-hover:scale-x-100 transition-transform duration-500" />
      </div>

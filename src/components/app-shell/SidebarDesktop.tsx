...
export const SidebarDesktop: React.FC<SidebarDesktopProps> = React.memo(({ groups, onClose, className }) => {
  ...
  return (
    <aside
      className={cn(
        'hidden h-screen min-w-[280px] max-w-[320px] flex-col gap-6 border-l border-[color:var(--glass-border)] bg-[color:var(--glass-bg)]/80 px-4 py-6 text-[color:var(--glass-fg)] shadow-[var(--shadow-glass-soft)] backdrop-blur-2xl lg:flex lg:flex-shrink-0',
        className
      )}

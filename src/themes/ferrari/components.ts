export const ferrariComponents = {
  button: {
    ...
    variants: {
      ...
      outline: "border-2 border-red-600/80 text-red-600 bg-slate-900/60 backdrop-blur-sm hover:bg-red-950/20 hover:border-red-600",

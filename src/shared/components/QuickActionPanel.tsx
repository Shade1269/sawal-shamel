...
const QuickActionPanel: React.FC<QuickActionPanelProps> = ({
  ...
  const getColorClasses = (color: QuickAction['color']) => {
    const colorMap = {
      ...
      success: {
        button: 'bg-gradient-success hover:shadow-success/25 border-success/20',
        icon: 'text-white',
        hover: 'hover:scale-105'
      },
      warning: {
        button: 'bg-gradient-warning hover:shadow-warning/25 border-warning/20',
        icon: 'text-white',
        hover: 'hover:scale-105'
      },
      destructive: {
        button: 'bg-gradient-danger hover:shadow-danger/25 border-danger/20',
        icon: 'text-white',
        hover: 'hover:scale-105'
      }
    };

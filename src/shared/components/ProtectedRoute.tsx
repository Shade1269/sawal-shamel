...
export const ProtectedRoute = ({ 
  ...
  if (!allowInactive && profile && !isActive) {
    return (
      <div className="min-h-screen bg-gradient-danger-light flex items-center justify-center p-4">
        <div className="max-w-md mx-auto text-center bg-background rounded-2xl shadow-2xl p-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">حساب معطل</h1>
  ...
  if (requiredRole && !hasRole(requiredRole)) {
    return (
      <div className="min-h-screen bg-gradient-warning-light flex items-center justify-center p-4">
        <div className="max-w-md mx-auto text-center bg-background rounded-2xl shadow-2xl p-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mb-2">غير مخول</h1>
          <p className="text-gray-600 mb-6">

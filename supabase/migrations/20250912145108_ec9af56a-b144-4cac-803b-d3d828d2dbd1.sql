...
('متجر ويباكس للإكسسوارات', 'wibax-accessories', '1e13f4d0-dbd2-4e42-a30b-7b8be15c442b', 'أحدث الإكسسوارات والحقائب النسائية', true, 'feminine'),
('متجر أحمد زاهر', 'ahmad-zaher-store', '41ac4816-977b-4b91-b4a9-8a8fa1cd7f71', 'منتجات متنوعة للرجال والنساء', true, 'damascus'),
('متجر مرام الأول', 'maram-store-1', '4c75d5dc-7ccf-440f-95a3-c0c6e3dcd38b', 'متجر شامل للأزياء والمستلزمات', true, 'feminine'),
('متجر مرام الثاني', 'maram-store-2', '9bd3b2e5-9d95-4f97-879a-b18f4798b5be', 'كولكشن حصري من أجمل القطع', true, 'classic');

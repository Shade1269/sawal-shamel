...
-- ===============================================
-- المرحلة 3 (تكملة - مُصحّحة): FKs للمخزون و CRM و Themes
-- ===============================================

-- ========== PART 1: Catalog & Inventory ==========

-- 1) product_variants.product_id
...
CREATE INDEX IF NOT EXISTS idx_inventory_warehouse_product_id 
...
-- 5) simple_order_items.product_id (حرج!)

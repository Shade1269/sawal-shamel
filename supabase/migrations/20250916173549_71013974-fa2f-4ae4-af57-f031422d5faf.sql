...
CREATE INDEX IF NOT EXISTS idx_ecom_orders_store_phone ON ecommerce_orders(affiliate_store_id, customer_phone);
...
CREATE INDEX IF NOT EXISTS idx_store_customers_store_cust ON store_customers(store_id, customer_id);

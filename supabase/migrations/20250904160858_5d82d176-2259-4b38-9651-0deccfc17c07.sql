...
-- 2. Secure sensitive tables (drop existing policies first)
ALTER TABLE public.event_log ENABLE ROW LEVEL SECURITY;

-- For points_events, drop existing policies and recreate
DROP POLICY IF EXISTS "Users can view own points_events" ON public.points_events;
DROP POLICY IF EXISTS "affiliate_select_points_events" ON public.points_events;
...
-- 5. Create security definer function and admin policies

...
BEGIN
  ...
  IF v_user_id IS NULL THEN
    ...
    INSERT INTO auth.users (phone, phone_confirmed, user_metadata)
    VALUES (p_phone, true, jsonb_build_object('full_name', COALESCE(p_full_name, p_phone)))
  ...
  IF v_profile_id IS NULL THEN
    INSERT INTO profiles (auth_user_id, phone, email, full_name, role, is_active)
    VALUES (v_user_id, p_phone, p_email, COALESCE(p_full_name, p_phone), 'customer', true)

-- إعادة هيكلة نظام الأدوار مع تنظيف البيانات أولاً
...
-- نقل البيانات الصالحة فقط من profiles إلى user_roles
INSERT INTO public.user_roles (user_id, role)
SELECT 
  p.auth_user_id,
  p.role
FROM public.profiles p
INNER JOIN auth.users u ON u.id = p.auth_user_id
...
-- دالة محسنة للحصول على دور المستخدم من الذاكرة المؤقتة

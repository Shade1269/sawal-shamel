-- Create RPC to safely create affiliate store under RLS
...
BEGIN
  ...
  -- Build unique slug if not provided
  ...
  -- Insert store (bypasses RLS safely via SECURITY DEFINER) and return id

...
test('app shell uses glass tokens for structural surfaces', async () => {
  mockRole = 'admin';
  ...
  assert.match(markup, /bg-\[color:var\(--glass-bg\)\]/);
  assert.match(markup, /border-\[color:var\(--glass-border\)\]/);
  assert.match(markup, /shadow-\[var\(--shadow-glass-soft\)\]/);
});
